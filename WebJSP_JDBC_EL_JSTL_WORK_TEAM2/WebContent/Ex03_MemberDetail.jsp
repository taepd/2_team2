...
<c:if
	test="${empty sessionScope.userid || sessionScope.userid != 'admin' }">
	<script>
		location.href = 'Ex02_JDBC_Login.jsp'
	</script>
</c:if>
		...
		<div id="left">
			...
			<div class="col-8"
				...
				-->
					...
					%>
					<table
						style="width: 400px; height: 100px; margin-left: auto; margin-right: auto;" class="table table-bordered">
						<tr>
