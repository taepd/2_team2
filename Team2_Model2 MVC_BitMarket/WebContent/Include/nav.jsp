   ...
   <div id="navbar">
		<div id="header">
			<nav class="navbar navbar-expand-lg  navigation">
				<a class="navbar-brand" href="BitMain.bit">
					<img src="images/logo.png" alt="">
				</a>
				<div class="collapse navbar-collapse d-flex justify-content-between">
					<form action="/action_page.php" class="input-group" style="width: 30%;">
						<input type="text" class="form-control" placeholder="검색어를 입력해주세요" id="myinput" name="search">
						<button type="button" id ="searchbtn" class="btn btn-outline-danger"><i class="svg-inline fa fa-search fa-w-16 fa-2x"></i></button>
					</form>
