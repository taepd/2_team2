...
<div class="preloader">
	...
	<div>
		<form name="board" action="NoticeUpdateOk.bit" method="POST">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td width="60%" align="left"><input type="text" name="title" size="60" value="${param.title }"> <label>&nbsp 공개여부 &nbsp<input type="checkbox" name="ncstate" value="Y" ${param.ncstate eq "Y" ? 'checked':""}></label></td>
                    </tr>
                      <tr>
                    ...
                    <tr>
                        ...
                        <td width="60%" align="left"><textarea id="summernote" rows="10" cols="60" name="nccontent" class="ckeditor">${param.nccontent}</textarea></td>
                    </tr>
                    <tr>
