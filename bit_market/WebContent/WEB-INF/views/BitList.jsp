	...
	$(function() {
		...
		$('#selecttag').change(function() {
			...
			if($('#selecttag option:selected').val() == "선택없음"){
				$(location).attr('href',"BitNorList.bit?cp=${cpage}&ps=${pagesize}");
			}
							...
							<tr>
								...
								<td class="product-details">
									...
									<c:forEach var="user" items="${userlist}">
										...
										<td class="product-category"><span class="categories">${board.ctname}</span></td>
			...
			<div class="pagination justify-content-center">
				<nav aria-label="Page navigation example">
					<ul class="pagination">
						...
						<c:when test="${cpage >1}">
						<li class="page-item">
						<a class="page-link" href="BitNorList.bit?cp=${cpage-1}&ps=${pagesize}" aria-label="Previous">
						...
						<c:choose>
							...
							<c:otherwise>
							<li class="page-item"><a class="page-link" href="BitNorList.bit?cp=${i}&ps=${pagesize}">${i}</a></li>
							</c:otherwise>
						</c:choose>
						</c:forEach>
						...
						<li class="page-item"><a class="page-link" href="BitNorList.bit?cp=${cpage+1}&ps=${pagesize}" aria-label="Next">
