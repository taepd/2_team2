...
<div class="preloader">
	...
	<div>
		<form name="board" action="BoardRewriteOk.board" method="POST" enctype="multipart/form-data">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td width="60%" align="left"><input type="text" name="email" size="40"></td>
                    </tr>
                    <tr>
                        <td width="40%" align="center">홈페이지</td>
                        <td width="60%" align="left"><input type="text" name="homepage" size="40" value="http://"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="60%" align="left"><input type="file" name="filename"></td>
                    </tr>
                    <tr>
