...
<div class="preloader">
	...
	<div>
		<form name="board" action="BoardUpdateOk.board?idx=${param.idx }" method="POST" enctype="multipart/form-data">
                <table class="table">
                    <tr>
                        <td width="40%" align="center">제목</td>
                        <td width="60%" align="left"><input type="text" name="subject" size="40" value="${param.subject }"></td>
                    </tr>
                    <tr>
                        <td width="40%" align="center">글쓴이</td>
                        <td width="60%" align="left"><input type="text" name="writer" size="40" value="${sessionScope.userid}" readonly></td>
                    </tr>
                    <tr>
                        <td width="40%" align="center">이메일</td>
                        <td width="60%" align="left"><input type="text" name="email" size="40" value="${param.email }"></td>
                    </tr>
                    <tr>
                        <td width="40%" align="center">홈페이지</td>
                        <td width="60%" align="left"><input type="text" name="homepage" size="40" value="${param.homepage }"></td>
                    </tr>
                    <tr>
                        <td width="40%" align="center">글내용</td>
                        <td width="60%" align="left"><textarea rows="10" cols="60" name="content" class="ckeditor">${param.content}</textarea></td>
                    </tr>
