...
public class ReplyUser_Join {
	...
	public String toString() {
		return "ReplyUser_Join [rpindex=" + rpindex + ", content=" + content + ", scstate=" + scstate + ", delstate="
				+ delstate + ", trstate=" + trstate + ", rtime=" + rtime + ", refer=" + refer + ", depth=" + depth
				+ ", step=" + step + ", id=" + id + ", bdindex=" + bdindex + ", nick=" + nick + "]";
	}
